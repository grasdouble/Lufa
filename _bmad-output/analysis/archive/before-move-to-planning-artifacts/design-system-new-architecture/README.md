...
**Location:** `brainstorming-session-2026-01-22.md` (root of design-system-new-architecture/)
...
│
├── 📚 HISTORY (Référence)
│ └── ../brainstorming-session-2026-01-22.md ← Brainstorming initial (root level)
│
└── 📦 ARCHIVES (Historical)
...
| Décisions architecture initiales? | brainstorming-session-2026-01-22.md (root level) |
