...
const CONTRAST_PAIRS: ContrastPair[] = [
  ...
  // Used in badges, alerts, banners - critical for status communication
  {
    ...
    fg: 'lufa-core-feedback-success-default',
    bg: 'lufa-core-feedback-success-subtle',
    required: 4.5,
    level: 'AA',
    blocking: true,
  },
  {
    ...
    fg: 'lufa-core-feedback-success-hover',
    bg: 'lufa-core-feedback-success-subtle',
    required: 3.0,
    level: 'AA-Large',
    blocking: true,
  },
  {
    ...
    fg: 'lufa-core-feedback-error-default',
    bg: 'lufa-core-feedback-error-subtle',
    required: 4.5,
    level: 'AA',
    blocking: true,
  },
  {
    ...
    fg: 'lufa-core-feedback-error-hover',
    bg: 'lufa-core-feedback-error-subtle',
    required: 3.0,
    level: 'AA-Large',
    blocking: true,
  },
  {
    ...
    fg: 'lufa-core-feedback-warning-default',
    bg: 'lufa-core-feedback-warning-subtle',
    required: 4.5,
    level: 'AA',
    blocking: true,
  },
  {
    ...
    fg: 'lufa-core-feedback-warning-hover',
    bg: 'lufa-core-feedback-warning-subtle',
    required: 3.0,
    level: 'AA-Large',
    blocking: true,
  },
  {
    ...
    fg: 'lufa-core-feedback-info-default',
    bg: 'lufa-core-feedback-info-subtle',
    required: 4.5,
    level: 'AA',
    blocking: true,
  },
  {
    ...
    fg: 'lufa-core-feedback-info-hover',
    bg: 'lufa-core-feedback-info-subtle',
    required: 3.0,
    level: 'AA-Large',
    blocking: true,
