...
export const fontSize = {
  ...
  xs: primitives.fontSize[12],
  /** 14px - Small text (captions, metadata) */
  sm: primitives.fontSize[14],
  /** 16px - Base/body text (WCAG minimum) */
  base: primitives.fontSize[16],
  /** 18px - Large body text */
  lg: primitives.fontSize[18],
  /** 20px - Extra large text */
  xl: primitives.fontSize[20],
  /** 24px - 2x large */
  '2xl': primitives.fontSize[24],
  /** 30px - 3x large */
  '3xl': primitives.fontSize[30],
  /** 36px - 4x large */
  '4xl': primitives.fontSize[36],
  /** 48px - 5x large */
  '5xl': primitives.fontSize[48],
  /** 60px - 6x large */
  '6xl': primitives.fontSize[60],
  /** 72px - 7x large */
  '7xl': primitives.fontSize[72],
  /** 96px - 8x large */
  '8xl': primitives.fontSize[96],
  /** 128px - 9x large */
  '9xl': primitives.fontSize[128],
} as const;
