      ...
      const component = await mount(
        <div style={{ padding: '32px', backgroundColor: 'var(--lufa-semantic-ui-background-page)', width: '800px' }}>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <Center
              style={{ width: '300px', height: '100px', border: '1px solid var(--lufa-semantic-ui-border-default)' }}
            >
          ...
          <section>
            ...
            <div style={{ border: '1px solid var(--lufa-semantic-ui-border-default)', padding: '8px' }}>
              Text before{' '}
              <Center inline style={{ border: '1px dashed var(--lufa-semantic-ui-border-default)', padding: '8px' }}>
