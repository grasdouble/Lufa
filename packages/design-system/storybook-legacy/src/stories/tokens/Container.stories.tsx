    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ marginBottom: '48px' }}>
        ...
        >
          ...
          <div
            style={{ padding: '32px', backgroundColor: tokens.color.surface.default, borderRadius: '6px' }}
          >
      ...
      <div style={{ marginBottom: '48px' }}>
        ...
        >
          ...
          <div
            style={{ padding: '24px', backgroundColor: tokens.color.surface.default, borderRadius: '6px' }}
          >
