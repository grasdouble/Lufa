...
const isTokenRatio = (ratio: AspectRatioValue): ratio is keyof typeof ASPECT_RATIO => typeof ratio === 'string' && ratio in ASPECT_RATIO;

/** Media container that preserves aspect ratio and prevents layout shift */
export const AspectRatio = forwardRef<HTMLElement, AspectRatioProps>(({ as = 'div', ratio = ASPECT_RATIO.video, className, style, children, ...props }, ref) => {
