        ...
        <div style={{ padding: '20px', maxWidth: '900px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
                <div>
                    ...
                    >
                        This paragraph uses enhanced readability settings with 1.65 line-height and 0.04em letter spacing. This
                        is ideal for long-form content and improves readability for users with dyslexia.
                    </p>
                </div>
                ...
                >
                    ...
                    <div>
                        <span style={{ color: '#F472B6' }}>const</span> message{' '}
                        <span style={{ color: '#F472B6' }}>=</span> <span style={{ color: '#A78BFA' }}>"Hello World"</span>;
                    </div>
                    <div>
                        <span style={{ color: '#F472B6' }}>console</span>.
                        <span style={{ color: '#60A5FA' }}>log</span>(message);
                    </div>
                </div>
