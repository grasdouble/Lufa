    ...
    render: () => (
        <div style={{ padding: '20px', maxWidth: '1400px' }}>
            ...
            <p style={{ marginBottom: '32px', color: '#737373', fontSize: '16px' }}>
                Fixed size values for element-level dimensions: icons, buttons, avatars, and touch targets. 
                Includes WCAG 2.5.5 minimum touch target size (44px).
            </p>
            ...
            >
                ...
                <p style={{ margin: 0, lineHeight: '1.6' }}>
                    <strong>Minimum 44×44px</strong> for all interactive elements (buttons, links, controls) 
                    to ensure usability on touch devices. This guideline helps users with motor impairments 
                    and reduces errors from accidental touches.
                </p>
            </div>
            ...
            >
                ...
                <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
                    <li><strong>16-32px:</strong> Icons in UI elements</li>
                    <li><strong>32-48px:</strong> Button heights, form inputs</li>
                    <li><strong>44px minimum:</strong> All interactive touch targets</li>
                    <li><strong>48-96px:</strong> Avatars (profile pictures)</li>
                    <li><strong>64-192px:</strong> Large images, logos, thumbnails</li>
                    <li><strong>For containers &gt;192px:</strong> Use maxWidth primitive instead</li>
                </ul>
            </div>
        </div>
    ),
