        ...
        <div style={{ padding: '20px', maxWidth: '1400px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
                {Object.entries(typography.fontWeight).map(([key, value]) => (
                    ...
                    >
                        <div style={{ fontFamily: 'monospace', fontWeight: '600', fontSize: '12px', marginBottom: '8px', color: '#737373' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                {Object.entries(typography.letterSpacing).map(([key, value]) => (
                    ...
                    >
                        ...
                        <div style={{ fontSize: '20px', letterSpacing: value as string }}>The quick brown fox jumps over the lazy dog</div>
                    </div>
                ))}
            </div>
        </div>
