    ...
    render: () => (
        <div style={{ padding: '20px', maxWidth: '1200px' }}>
            ...
            <div style={{ marginBottom: '40px' }}>
                ...
                >
                    <div style={{ color: '#737373', marginBottom: '12px' }}>
                        {`import { maxWidth } from '@grasdouble/lufa_design-system';`}
                    </div>
                    ...
                    <div style={{ marginTop: '8px' }}>
                        <span style={{ color: '#E5C07B' }}>max-width</span>:{' '}
                        <span style={{ color: '#98C379' }}>var</span>
                ...
                <div key={size} style={{ marginBottom: '32px' }}>
                    ...
                    >
                        <p style={{ margin: 0, color: '#525252', fontSize: '14px' }}>
                            This container has a max-width of <strong>{maxWidth[size]}</strong>. It will shrink on smaller
