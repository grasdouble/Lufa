    ...
    render: () => (
        <div style={{ padding: '20px', maxWidth: '1400px' }}>
            ...
            <p style={{ marginBottom: '32px', color: '#737373', fontSize: '16px' }}>
                Standardized focus indicators for keyboard navigation. WCAG 2.1 requires minimum 2px indicator with 3:1 contrast.
            </p>
    ...
    render: () => {
        ...
        return (
            <div style={{ padding: '20px', maxWidth: '1400px' }}>
                ...
                <p style={{ marginBottom: '32px', color: '#737373', fontSize: '16px' }}>
                    Use <code style={{ padding: '2px 6px', backgroundColor: '#E5E5E5', borderRadius: '4px' }}>getFocusStyle()</code>{' '}
                ...
                <div style={{ marginTop: '24px', fontSize: '14px', color: '#737373' }}>
                    💡 <strong>Tip:</strong> Tab through the buttons above to see each focus style in action. The code snippet updates
                    to show how to use the getFocusStyle() helper.
                </div>
            </div>
        );
    },
