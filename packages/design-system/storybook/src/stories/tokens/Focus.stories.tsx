        ...
        {Object.entries(tokens.focus).map(([key, value]) => (
          ...
          >
            <div style={{ marginBottom: '16px' }}>
              ...
              <div
                style={{ fontFamily: 'monospace', fontSize: '11px', color: tokens.color.text.tertiary, }}
              >
          ...
          {Object.keys(tokens.focus).map((key) => (
            <button
              ...
              style={{
                ...
                backgroundColor:
                  key === 'inverse'
                    ? '${tokens.color.background.inverse}'
                    : '${tokens.color.surface.default}',
                color:
                  key === 'inverse' ? '${tokens.color.text.inverse}' : '${tokens.color.text.primary}',
