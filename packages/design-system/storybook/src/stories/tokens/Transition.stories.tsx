        ...
        return (
            <div style={{ padding: '20px', maxWidth: '1400px' }}>
                ...
                <div style={{ marginBottom: '48px' }}>
                    <h2 style={{ fontSize: '24px', fontWeight: '600', marginBottom: '16px' }}>Fast Transitions (Hover Effects)</h2>
                    ...
                    <p style={{ marginTop: '12px', fontSize: '12px', color: '#737373' }}>Using transition.fast for smooth hover effects</p>
                </div>
                ...
                {/* Color Transitions */}
                <div>
                    <h2 style={{ fontSize: '24px', fontWeight: '600', marginBottom: '16px' }}>Color Transitions (Theme Switching)</h2>
