    ...
    render: () => (
        <div style={{ padding: '20px', maxWidth: '1000px' }}>
            ...
            <p style={{ marginBottom: '32px', color: '#737373', fontSize: '16px' }}>
                Standardized opacity values for overlays, disabled states, and visual hierarchy. Use with caution on text to maintain
            ...
            >
                ...
                <p style={{ margin: '0', color: '#737373', fontSize: '14px', lineHeight: '1.6' }}>
                    <strong>WCAG 2.1 Compliance:</strong> When applying opacity to text or interactive elements, always verify that
                    contrast ratios meet minimum requirements:
                </p>
                <ul style={{ margin: '12px 0 0 0', paddingLeft: '20px', color: '#737373', fontSize: '14px', lineHeight: '1.6' }}>
        ...
        <div style={{ padding: '20px', maxWidth: '1000px' }}>
            ...
            <div style={{ marginBottom: '32px' }}>
                ...
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                    <div style={{ position: 'relative', width: '200px', height: '150px', borderRadius: '8px', overflow: 'hidden' }}>
                        <img
