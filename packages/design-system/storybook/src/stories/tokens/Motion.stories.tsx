        ...
        return (
            <div style={{ padding: '20px', maxWidth: '1000px' }}>
                ...
                >
                    {Object.entries(timing).map(([key, value]) => (
                        <div key={key}>
                            ...
                            >
                                <span style={{ fontWeight: '600', color: activeBox === key ? 'white' : '#737373' }}>
                                    Click me
                                </span>
                            </div>
                ...
                >
                    ...
                    <ul style={{ margin: '0', paddingLeft: '20px', color: '#737373', fontSize: '14px', lineHeight: '1.6' }}>
        ...
        return (
            <div style={{ padding: '20px', maxWidth: '1000px' }}>
                ...
                >
                    ...
                    <ul style={{ margin: '0', paddingLeft: '20px', color: '#737373', fontSize: '14px', lineHeight: '1.6' }}>
                        <li><strong>easeIn:</strong> Elements entering the viewport</li>
                        <li><strong>easeOut:</strong> Elements exiting the viewport</li>
                        <li><strong>easeInOut:</strong> Movement within the viewport</li>
                        <li><strong>gentle:</strong> Smooth, less jarring motion for larger elements</li>
                    </ul>
                </div>
            </div>
        );
