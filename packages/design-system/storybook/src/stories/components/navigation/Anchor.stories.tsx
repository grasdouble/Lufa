...
const meta = {
    ...
    argTypes: {
        ...
        variant: { control: 'select', options: ['default', 'underline', 'subtle'], description: 'Visual style variant' },
...
export const InContext: Story = {
    render: () => (
        <div>
            ...
            <nav style={{ marginBottom: '32px', padding: '16px', backgroundColor: color.background.secondary, borderRadius: '8px' }}>
