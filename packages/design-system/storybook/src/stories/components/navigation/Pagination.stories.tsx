...
export const CustomText: Story = {
    render: () => {
        const [current, setCurrent] = useState(1);
        return <Pagination current={current} total={100} pageSize={10} onChange={setCurrent} prevText="Previous" nextText="Next" />;
    },
};
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '16px' }}>
                    <thead>
                        <tr style={{ backgroundColor: color.background.secondary }}>
                            <th style={{ padding: '12px', textAlign: 'left', borderBottom: `2px solid ${color.border.light}` }}>ID</th>
                            <th style={{ padding: '12px', textAlign: 'left', borderBottom: `2px solid ${color.border.light}` }}>Name</th>
                            <th style={{ padding: '12px', textAlign: 'left', borderBottom: `2px solid ${color.border.light}` }}>
                                Description
                            </th>
                        </tr>
                    </thead>
