...
const tabsWithIcons = [
    ...
    { key: 'profile', label: 'Profile', icon: <UserIcon />, children: <div style={{ padding: '16px' }}>Profile content</div> },
    { key: 'settings', label: 'Settings', icon: <SettingsIcon />, children: <div style={{ padding: '16px' }}>Settings content</div> },
];
    ...
    render: () => (
        <Tabs
            items={[
                ...
                { key: 'tab2', label: 'Disabled Tab', children: <div style={{ padding: '16px' }}>Disabled content</div>, disabled: true },
                { key: 'tab3', label: 'Another Active', children: <div style={{ padding: '16px' }}>Another active content</div> },
            ]}
        />
    ),
};
                    ...
                    },
                    {
                        ...
                        children: (
                            <div style={{ padding: '24px' }}>
                                ...
                                <div style={{ padding: '16px', backgroundColor: color.background.secondary, borderRadius: '8px' }}>
