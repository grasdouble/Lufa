...
const meta = {
    ...
    argTypes: {
        ...
        variant: { control: 'select', options: ['solid', 'outlined', 'text', 'ghost', 'link'], description: 'Visual style variant' },
        color: { control: 'select', options: ['primary', 'secondary', 'success', 'warning', 'danger'], description: 'Color scheme' },
