  ...
  render: () => (
    <div
      style={{
        ...
        maxWidth: 'var(--lufa-token-max-width-lg)',
      }}
    >
      <div>
        <h3 style={{ marginBottom: 'var(--lufa-token-spacing-sm)' }}>Form Validation</h3>
        <Alert variant="error" title="Validation Failed" closable>
          Please fix the following errors:
          <ul
            style={{
              marginTop: 'var(--lufa-token-spacing-sm)',
              marginBottom: 'var(--lufa-token-spacing-none)',
              paddingLeft: 'var(--lufa-token-spacing-md-lg)',
            }}
          >
      ...
      <div>
        <h3 style={{ marginBottom: 'var(--lufa-token-spacing-sm)' }}>Success Notification</h3>
      ...
      <div>
        <h3 style={{ marginBottom: 'var(--lufa-token-spacing-sm)' }}>Important Notice</h3>
      ...
      <div>
        <h3 style={{ marginBottom: 'var(--lufa-token-spacing-sm)' }}>Helpful Tip</h3>
        <Alert variant="info" title="Pro Tip">
          ...
          <code
            style={{
              ...
              padding: `var(--lufa-token-spacing-xxs) var(--lufa-token-spacing-2xs)`,
