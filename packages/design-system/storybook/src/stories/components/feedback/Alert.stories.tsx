...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Display important messages to users with different severity levels. Supports titles, icons, and dismissal.',
            },
        },
    },
    tags: [],
...
export const LongContent: Story = {
    render: () => (
        <Alert variant="info" title="Detailed Information">
            This is a longer alert message that demonstrates how the Alert component handles more extensive content. It includes multiple
            sentences and provides detailed information to the user. The component will naturally expand to accommodate the content while
