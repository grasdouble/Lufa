...
export const UsageExamples: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: tokens.spacing.lg, maxWidth: tokens.maxWidth.lg }}>
      ...
      <div>
        <h3 style={{ marginBottom: tokens.spacing.sm }}>Success Notification</h3>
      ...
      <div>
        <h3 style={{ marginBottom: tokens.spacing.sm }}>Important Notice</h3>
      ...
      <div>
        <h3 style={{ marginBottom: tokens.spacing.sm }}>Helpful Tip</h3>
        <Alert variant="info" title="Pro Tip">
          ...
          <code
            style={{
              ...
              padding: `${tokens.spacing.xxs} ${tokens.spacing['2xs']}`,
