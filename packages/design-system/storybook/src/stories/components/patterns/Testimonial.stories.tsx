...
const getArgTypesWithSpecificStyle = (styleValue: number) => ({
  ...meta.argTypes,
  style: {
    control: 'select',
    description: 'The style of the testimonial',
...
export const Style1: Story = {
  argTypes: getArgTypesWithSpecificStyle(1),
  args: {
    style: 1,
    imgUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9',
    testimonial:
...
export const Style2: Story = {
  argTypes: getArgTypesWithSpecificStyle(2),
  args: {
    style: 2,
    imgUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9',
    testimonial:
...
export const Style3: Story = {
  argTypes: getArgTypesWithSpecificStyle(3),
  args: {
    style: 3,
    imgUrl:
      'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=576&h=576&q=80',
