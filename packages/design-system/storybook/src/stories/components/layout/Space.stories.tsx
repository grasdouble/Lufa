...
import { Container, Placeholder, Space, SPACE_DIRECTION, SPACE_SIZE, Stack, tokens } from '@grasdouble/lufa_design-system';
...
const meta = {
    ...
    argTypes: {
        ...
        direction: { control: 'inline-radio', options: Object.values(SPACE_DIRECTION), table: { defaultValue: { summary: 'vertical' } } },
        ...
        <Container size="md" paddingX="none">
            <div style={{ backgroundColor: color.background.secondary, borderRadius: '12px', padding: '16px' }}>
                <DemoLabel
                    ...
                    value={
                        typeof args.size === 'string' && args.size in SPACE_SIZE ? spacing[args.size as keyof typeof spacing] : undefined
                    }
                />
