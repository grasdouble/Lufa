...
export const Playground: Story = {
    args: {
        ...
        children: (
            <>
                <Placeholder color={colors.interactive.default}>Item 1</Placeholder>
                <Placeholder color={colors.interactive.default}>Item 2</Placeholder>
                <Placeholder color={colors.interactive.default}>Item 3</Placeholder>
            </>
        ),
    },
};
...
export const VerticalStack: Story = {
    render: () => (
        <Stack direction={STACK_DIRECTION.vertical} gap={STACK_GAP.normal}>
            <Placeholder color={colors.interactive.default}>First Item</Placeholder>
            <Placeholder color={colors.interactive.default}>Second Item</Placeholder>
            <Placeholder color={colors.interactive.default}>Third Item</Placeholder>
        </Stack>
    ),
};
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            <div>
                ...
                <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.none}>
                    <Placeholder color={colors.interactive.default}>A</Placeholder>
                    <Placeholder color={colors.interactive.default}>B</Placeholder>
                    <Placeholder color={colors.interactive.default}>C</Placeholder>
                </Stack>
            </div>
            <div>
                    ...
                    <div>
                        ...
                        >
                            <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} align={STACK_ALIGN.start}>
                                <Placeholder color={colors.interactive.default} height="small">
                                    Small
                                </Placeholder>
                                <Placeholder color={colors.interactive.default} height="medium">
                                    Medium
                                </Placeholder>
                                <Placeholder color={colors.interactive.default} height="large">
                                    Large
                                </Placeholder>
                            </Stack>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} align={STACK_ALIGN.center}>
                                <Placeholder color={colors.success.default} height="small">
                                    Small
                                </Placeholder>
                                <Placeholder color={colors.success.default} height="medium">
                                    Medium
                                </Placeholder>
                                <Placeholder color={colors.success.default} height="large">
                                    Large
                                </Placeholder>
                            </Stack>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} align={STACK_ALIGN.end}>
                                <Placeholder color={colors.error.default} height="small">
                                    Small
                                </Placeholder>
                                <Placeholder color={colors.error.default} height="medium">
                                    Medium
                                </Placeholder>
                                <Placeholder color={colors.error.default} height="large">
                                    Large
                                </Placeholder>
                            </Stack>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} align={STACK_ALIGN.stretch}>
                                <Placeholder color={colors.brand.secondary} height="full">
                                    Stretched 1
                                </Placeholder>
                                <Placeholder color={colors.brand.secondary} height="full">
                                    Stretched 2
                    ...
                    <div>
                        ...
                        >
                            <Stack direction={STACK_DIRECTION.vertical} gap={STACK_GAP.normal} align={STACK_ALIGN.start}>
                                <Placeholder color={colors.interactive.default} width="small">
                                    Short
                                </Placeholder>
                                <Placeholder color={colors.interactive.default} width="medium">
                                    Medium Width
                                </Placeholder>
                                <Placeholder color={colors.interactive.default} width="large">
                                    Very Long Width
                                </Placeholder>
                            </Stack>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <Stack direction={STACK_DIRECTION.vertical} gap={STACK_GAP.normal} align={STACK_ALIGN.center}>
                                <Placeholder color={colors.success.default} width="small">
                                    Short
                                </Placeholder>
                                <Placeholder color={colors.success.default} width="medium">
                                    Medium Width
                                </Placeholder>
                                <Placeholder color={colors.success.default} width="large">
                                    Very Long Width
                                </Placeholder>
                            </Stack>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <Stack direction={STACK_DIRECTION.vertical} gap={STACK_GAP.normal} align={STACK_ALIGN.end}>
                                <Placeholder color={colors.error.default} width="small">
                                    Short
                                </Placeholder>
                                <Placeholder color={colors.error.default} width="medium">
                                    Medium Width
                                </Placeholder>
                                <Placeholder color={colors.error.default} width="large">
                                    Very Long Width
                                </Placeholder>
                            </Stack>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <Stack direction={STACK_DIRECTION.vertical} gap={STACK_GAP.normal} align={STACK_ALIGN.stretch}>
                                <Placeholder color={colors.brand.secondary} width="full">
                                    Stretched Item 1
                                </Placeholder>
                                <Placeholder color={colors.brand.secondary} width="full">
                                    Stretched Item 2
    ...
    render: () => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            <div>
                ...
                <div style={{ width: '600px', backgroundColor: colors.background.secondary, padding: '16px' }}>
                ...
                >
                    <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} wrap={STACK_WRAP.nowrap}>
                        {[1, 2, 3, 4, 5, 6, 7, 8].map((n) => (
                            <Placeholder key={n} color={colors.error.default} width="small">
                                Item {n}
                            </Placeholder>
                        ))}
                    </Stack>
            ...
            <div>
                ...
                <div
                    style={{
                        ...
                        backgroundColor: colors.background.secondary,
                        padding: '16px',
                        border: `2px dashed ${colors.success.border}`,
                    }}
                >
                    <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} wrap={STACK_WRAP.wrap}>
                        {[1, 2, 3, 4, 5, 6, 7, 8].map((n) => (
                            <Placeholder key={n} color={colors.success.default} width="small">
                                Item {n}
                            </Placeholder>
                        ))}
                    </Stack>
    ...
    render: () => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            <div>
                ...
                <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal}>
                    <Stack.Item>
                        <Placeholder color={colors.error.default}>Fixed</Placeholder>
                    </Stack.Item>
                    <Stack.Item>
                        <Placeholder color={colors.interactive.default}>Fixed</Placeholder>
                    </Stack.Item>
                    <Stack.Item>
                        <Placeholder color={colors.success.default}>Fixed</Placeholder>
                    </Stack.Item>
                </Stack>
            </div>
            ...
            <div>
                ...
                <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal}>
                    ...
                    <Stack.Item grow>
                        <Placeholder color={colors.interactive.default}>Growing</Placeholder>
                    </Stack.Item>
                    <Stack.Item>
                        <Placeholder color={colors.success.default}>Fixed</Placeholder>
                    </Stack.Item>
            ...
            <div>
                ...
                <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal}>
                    ...
                    <Stack.Item grow>
                        <Placeholder color={colors.success.default}>Growing</Placeholder>
                    </Stack.Item>
                </Stack>
            </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '40px', maxWidth: '800px' }}>
            <div>
                ...
                <Stack direction={STACK_DIRECTION.vertical} gap={STACK_GAP.normal}>
                    <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal}>
                        <Stack.Item grow>
                            <Placeholder color={colors.info.default}>First Name</Placeholder>
                        </Stack.Item>
                        <Stack.Item grow>
                            <Placeholder color={colors.info.default}>Last Name</Placeholder>
                        </Stack.Item>
                    </Stack>
                    <Placeholder color={colors.info.default}>Email</Placeholder>
                    <Placeholder color={colors.info.default}>Message</Placeholder>
                    <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} justify={STACK_JUSTIFY.end}>
                        <Placeholder color={colors.text.disabled}>Cancel</Placeholder>
                        <Placeholder color={colors.interactive.default}>Submit</Placeholder>
                    </Stack>
                </Stack>
            </div>
            ...
            <div>
                ...
                <div style={{ backgroundColor: colors.background.inverse, borderRadius: '8px' }}>
                    <Stack
                    ...
                    >
                        <Placeholder color={colors.interactive.focus}>Logo</Placeholder>
                        <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal}>
                            <Placeholder color={colors.text.tertiary}>Home</Placeholder>
                            <Placeholder color={colors.text.tertiary}>About</Placeholder>
                            <Placeholder color={colors.text.tertiary}>Contact</Placeholder>
                        </Stack>
                        <Placeholder color={colors.success.hover}>Sign In</Placeholder>
                    </Stack>
                </div>
            </div>
                ...
                <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} wrap={STACK_WRAP.wrap}>
                    {[1, 2, 3, 4, 5, 6].map((n) => (
                        <div key={n} style={{ flex: '1 1 200px' }}>
                            <Placeholder color={colors.brand.secondary}>Card {n}</Placeholder>
                        </div>
                    ))}
                </Stack>
            </div>
                ...
                <Stack direction={STACK_DIRECTION.horizontal} gap={STACK_GAP.normal} align={STACK_ALIGN.stretch}>
                    <Stack.Item>
                        <div style={{ height: '200px' }}>
                            <Placeholder color={colors.text.secondary} height="full">
                                Sidebar
                            </Placeholder>
                        </div>
                    </Stack.Item>
                    <Stack.Item grow>
                        <Stack direction={STACK_DIRECTION.vertical} gap={STACK_GAP.normal}>
                            <Placeholder color={colors.interactive.default}>Header</Placeholder>
                            <div style={{ height: '140px' }}>
                                <Placeholder color={colors.info.default} height="full">
                                    Main Content
                                </Placeholder>
                            </div>
                        </Stack>
