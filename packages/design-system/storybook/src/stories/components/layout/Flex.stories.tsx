...
const meta = {
    ...
    argTypes: {
        ...
        direction: { control: 'select', options: Object.values(FLEX_DIRECTION), table: { defaultValue: { summary: 'row' } } },
        align: { control: 'select', options: Object.values(FLEX_ALIGN), table: { defaultValue: { summary: 'stretch' } } },
        justify: { control: 'select', options: Object.values(FLEX_JUSTIFY), table: { defaultValue: { summary: 'start' } } },
        ...
        <Container size="lg" paddingX="none">
            <Stack direction="vertical" gap="spacious">
                {([FLEX_WRAP.nowrap, FLEX_WRAP.wrap] as const).map((wrap) => (
                    <div
                        key={wrap}
                        style={{ backgroundColor: color.background.secondary, borderRadius: '12px', padding: '16px', overflow: 'auto' }}
                    >
                        <div style={{ fontFamily: 'monospace', color: color.text.secondary, marginBottom: '12px' }}>wrap: {wrap}</div>
                        <Flex
                            wrap={wrap}
                            gap="md"
