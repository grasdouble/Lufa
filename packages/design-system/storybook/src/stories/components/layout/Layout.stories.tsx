...
import { Container, Layout, LAYOUT_GAP, LAYOUT_SIDEBAR_POSITION, LAYOUT_SIDEBAR_WIDTH, Placeholder, Stack, tokens } from '@grasdouble/lufa_design-system';
...
const meta = {
    ...
    argTypes: {
        ...
        sidebarPosition: { control: 'inline-radio', options: Object.values(LAYOUT_SIDEBAR_POSITION), table: { defaultValue: { summary: 'left' } } },
        sidebarWidth: { control: 'select', options: Object.values(LAYOUT_SIDEBAR_WIDTH), table: { defaultValue: { summary: 'default' } } },
        ...
        <Container size="xl" paddingX="none">
            <Stack direction="vertical" gap="spacious">
                {(Object.values(LAYOUT_SIDEBAR_WIDTH) as Array<keyof typeof LAYOUT_SIDEBAR_WIDTH>).map((width) => (
                    ...
                    >
                        <Layout.Header>
                            <div style={{ fontFamily: 'monospace', color: color.text.secondary, marginBottom: '8px' }}>sidebarWidth: {width}</div>
                            <Placeholder color={color.interactive.default} height="small" width="full">
                                Header
                            </Placeholder>
                        </Layout.Header>
