...
import {
  ...
  SubmenuExample,
  Theme,
} from '../../../src/dsExamples/navigation/menu';
...
```
┌──────────────────────────┐
│  [Icon] Item 1           │  ← Menu Item
│  [Icon] Item 2      [▸]  │  ← Menu Item with Submenu Indicator
│    ├─ Submenu Item 1     │  ← Submenu (nested)
│    └─ Submenu Item 2     │
│  [Icon] Item 3           │  ← Menu Item (selected)
│         ═══════          │  ← Selection Indicator
└──────────────────────────┘
```
...
- **Submenu Indicator** (optional): Arrow showing expandable children (▸)
...
import { Menu } from '@grasdouble/lufa_design-system';
import { HomeIcon, UsersIcon, SettingsIcon, FileIcon } from './icons';
