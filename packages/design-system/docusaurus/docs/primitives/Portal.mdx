...
import { LiveDemo, PortalWithContainer } from '../../src/dsExamples/primitives/portal';
...
<LiveDemoSection
  tabs={[
    ...
    { id: 'container', label: 'Container', content: <BrowserOnly>{() => <PortalWithContainer />}</BrowserOnly> },
  ]}
/>
