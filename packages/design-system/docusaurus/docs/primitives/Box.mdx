...
<LiveDemoSection
  tabs={[
    ...
    { id: 'padding', label: 'Padding', content: <PaddingVariants /> },
    { id: 'margin', label: 'Margin', content: <MarginVariants /> },
    { id: 'background', label: 'Background', content: <BackgroundVariants /> },
    { id: 'border', label: 'Border', content: <BorderVariants /> },
    { id: 'display', label: 'Display', content: <DisplayVariants /> },
