...
import { AlignDemo, ColumnsDemo, GapDemo, JustifyDemo, LiveDemo } from '../../src/dsExamples/primitives/grid';
...
<LiveDemoSection
  tabs={[
    ...
    { id: 'columns', label: 'Columns', content: <ColumnsDemo /> },
    { id: 'gaps', label: 'Gaps', content: <GapDemo /> },
