...
See [Button component documentation](/docs/components/button) for a complete example following this template.
...
- [Button Component](/docs/components/button) - Example of well-documented component
