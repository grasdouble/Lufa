...
See [Button component documentation](../components/Button.mdx) for a complete example following this template.
...
- [Button Component](../components/Button.mdx) - Example of well-documented component
