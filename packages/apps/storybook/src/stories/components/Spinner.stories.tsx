...
const meta = {
    title: '1. Components/Feedback/Spinner',
    component: Spinner,
    parameters: {
        layout: 'centered',
        docs: {
            description: {
                component: 'A loading spinner component to indicate processing or loading states. Available in multiple sizes and modes.',
            },
        },
    },
    tags: ['autodocs'],
