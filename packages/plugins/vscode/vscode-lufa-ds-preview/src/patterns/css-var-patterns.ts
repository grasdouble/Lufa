 ...
 */
const cssVarNameRe = /--lufa-(?:primitive|core|semantic|component)-[a-zA-Z0-9-]+/;
const cssColorVarNameRe = /--lufa-(?:primitive|core|semantic|component)-[a-zA-Z0-9-]*color-[a-zA-Z0-9-]+/;
 ...
 */
const createCssColorVarDirectRe = (): RegExp => new RegExp(`(${cssColorVarNameRe.source})(?=\\s*:)`, 'gi');
...
export { cssVarNameRe, createCssColorVarInVarRe, createCssColorVarDirectRe, createOklchColorRe };
