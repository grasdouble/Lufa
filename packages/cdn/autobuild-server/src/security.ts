...
export const ipBlockMiddleware = (blockedIPs:Set<string>) => (req: Request, res: Response, next: NextFunction): void => {
...
export const getRateLimiter = (blockedIPs:Set<string>) => rateLimit({
