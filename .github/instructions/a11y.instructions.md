...
5. Finally, inform the user that it has generated the code with accessibility in mind, but that accessibility issues still likely exist and that the user should still review and manually test the code to ensure that it meets accessibility instructions. **Use the WCAG 2.2 Quick Checklist below to verify compliance.** Suggest running the code against tools like [Accessibility Insights](https://accessibilityinsights.io/). Do not explain the accessibility features unless asked. Keep verbosity to a minimum.

---

## WCAG 2.2 Level AA Quick Checklist

Use this checklist to verify accessibility compliance. For detailed guidance, see sections below.

### ✅ Perceivable

- [ ] **Text Alternatives** (1.1.1): All images, icons, and graphics have appropriate alt text or are marked decorative
- [ ] **Time-based Media** (1.2.1-1.2.5): Captions for videos, audio descriptions where needed
- [ ] **Adaptable** (1.3.1-1.3.5): Semantic HTML, correct heading hierarchy, no skipped levels
- [ ] **Distinguishable** (1.4.1-1.4.11):
  - Color not sole means of conveying information
  - Text contrast minimum 4.5:1 (3:1 for large text 18.5px+ bold or 24px+)
...
- [ ] **Keyboard Accessible** (2.1.1-2.1.4):
  ...
  - Keyboard shortcuts don't conflict or can be disabled
- [ ] **Enough Time** (2.2.1-2.2.2): Users can extend time limits, pause/stop moving content
...
- [ ] **Readable** (3.1.1-3.1.2): Page language declared, language of parts declared when different
...
- [ ] **Input Assistance** (3.3.1-3.3.4):
  - Error messages identify errors and provide correction suggestions
...
- [ ] **Compatible** (4.1.1-4.1.3):
  ...
  - Name, role, value of all UI components can be determined
  - Status messages can be determined without focus

### WCAG 2.2 New Criteria

- [ ] **Focus Not Obscured (Minimum)** (2.4.11): Focused element not entirely hidden by author-created content
- [ ] **Focus Not Obscured (Enhanced)** (2.4.12 - AAA): No part of focused element hidden
- [ ] **Focus Appearance** (2.4.13 - AAA): Focus indicator has minimum size and contrast
- [ ] **Dragging Movements** (2.5.7): Functionality using dragging has single-pointer alternative
- [ ] **Target Size (Minimum)** (2.5.8): 24x24 CSS pixels minimum (with exceptions)
- [ ] **Consistent Help** (3.2.6): Help mechanisms in same order across pages
- [ ] **Redundant Entry** (3.3.7): Information previously entered is pre-filled or available
- [ ] **Accessible Authentication (Minimum)** (3.3.8): Cognitive function test not required (exceptions for object recognition)
- [ ] **Accessible Authentication (Enhanced)** (3.3.9 - AAA): No cognitive function test required

### Testing Tools

- **Automated**: [axe DevTools](https://www.deque.com/axe/devtools/), [WAVE](https://wave.webaim.org/)
- **Manual**: [Accessibility Insights](https://accessibilityinsights.io/)
- **Screen Readers**: NVDA (Windows), JAWS, VoiceOver (Mac/iOS)
- **Keyboard**: Test with Tab, Shift+Tab, Enter, Escape, Arrow keys
