...
**Framework Location:**
`data/integration-patterns-analysis-framework.md`

Load the integration patterns analysis framework from the data file. This framework provides:

- Complete 7-subsection structure for integration patterns
- API design patterns and communication protocols templates
- Data formats and system interoperability structure
- Microservices and event-driven integration templates
- Security patterns format
- Source citation formats

Using the framework structure from `data/integration-patterns-analysis-framework.md`:

1. **Fill all 7 subsections** with synthesized integration patterns content from web searches
2. **Maintain source citations** throughout with verified URLs
3. **Ensure comprehensive coverage** across all integration aspects
